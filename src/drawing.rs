...
use crate::constants::{BOARD_POS, BOARD_SIDE, SQUARE_SIZE, WINDOW_SIZE};
    ...
    for i in 0..BOARD_SIDE + 1 {
        let _ = mb.line(
            &[
                ...
                Point2::new(
                    BOARD_POS.0 + SQUARE_SIZE * i as f32,
                    BOARD_POS.1 + SQUARE_SIZE * BOARD_SIDE as f32,
                ),
            ],
            4.0,
            graphics::BLACK,
    ...
    for i in 0..BOARD_SIDE + 1 {
        let _ = mb.line(
            &[
                ...
                Point2::new(
                    BOARD_POS.0 + SQUARE_SIZE * BOARD_SIDE as f32,
...
pub fn draw_selected_cell(mb: &mut MeshBuilder, index_x: usize, index_y: usize) {
    ...
    let _ = mb.line(
        &[
            Point2::new(
                BOARD_POS.0 + SQUARE_SIZE * index_x as f32 + offset,
                BOARD_POS.1 + SQUARE_SIZE * index_y as f32 + offset - 1.0,
            ),
            Point2::new(
                BOARD_POS.0 + SQUARE_SIZE * (index_x + 1) as f32 - offset,
                BOARD_POS.1 + SQUARE_SIZE * index_y as f32 + offset - 1.0,
            ),
        ],
        width,
    ...
    let _ = mb.line(
        &[
            Point2::new(
                BOARD_POS.0 + SQUARE_SIZE * (index_x + 1) as f32 - offset + 1.0,
                BOARD_POS.1 + SQUARE_SIZE * index_y as f32 + offset,
            ),
            Point2::new(
                BOARD_POS.0 + SQUARE_SIZE * (index_x + 1) as f32 - offset + 1.0,
...
pub fn draw_red_line(mb: &mut MeshBuilder, index_first: usize, index_second: usize) {
    ...
    let _ = mb.line(
        &[
            Point2::new(
                BOARD_POS.0 + SQUARE_SIZE * point1_x as f32 + SQUARE_SIZE / 2.0,
                BOARD_POS.1 + SQUARE_SIZE * point1_y as f32 + SQUARE_SIZE / 2.0,
            ),
            Point2::new(
                BOARD_POS.0 + SQUARE_SIZE * point2_x as f32 + SQUARE_SIZE / 2.0,
...
pub fn draw_player_o(mb: &mut MeshBuilder, pos_x: usize, pos_y: usize) {
    mb.circle(
        ...
        Point2::new(
            BOARD_POS.0 + (pos_x as f32 + 0.5) * SQUARE_SIZE,
...
pub fn draw_player_x(mb: &mut MeshBuilder, pos_x: usize, pos_y: usize) {
    let _ = mb.line(
        &[
            Point2::new(
                BOARD_POS.0 + SQUARE_SIZE * (pos_x as f32 + 0.25),
                BOARD_POS.1 + SQUARE_SIZE * (pos_y as f32 + 0.25),
            ),
            Point2::new(
                BOARD_POS.0 + SQUARE_SIZE * (pos_x as f32 + 0.75),
...
pub fn draw_text(ctx: &mut Context, text: &str) {
    ...
    let _ = graphics::draw(
        ctx,
        &display_text,
        (Point2::new(0.0, WINDOW_SIZE.1 * 0.9), graphics::WHITE),
    );
}
